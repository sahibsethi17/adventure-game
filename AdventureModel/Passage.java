...
public class Passage implements Serializable {
    ...
    /**
     * The name of the secret keys required to move along this passage.
     */

    private ArrayList<String> secretKey;
    ...
    public Passage(String direction, String roomNumber, ArrayList<String> keys, boolean isLocked) {
        this.direction = direction;
        this.destinationRoom = Integer.parseInt(roomNumber);
        this.secretKey = keys;
    ...
    /**
     * Returns if the passage is locked.
     *
     * @return True if the passage is locked, false otherwise.
     */
    public boolean getIsLocked() {
        return this.isLocked;
    }
    /**
     * Returns the name of the secret keys required to move along this passage,
     * or null if no object is required.
     *
     * @return The name of the required object, or null if no object is required.
     */
